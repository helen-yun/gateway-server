package com.pongift.common.config;
...
/**
 * Mybatis에서 생성되는 SQL에 디버깅용 comment를 추가합니다. <br> <b>개발편의<b/>를 위한 기능이며, 운영시에는 설정하지 않는것을 권장합니다.
 *
 * @author Sejong Park
 **/
@Slf4j public class EnhanceMybatisLanguageDriver extends XMLLanguageDriver {
	...
	@SneakyThrows private void addDebuggingComment(BoundSql boundSql) {
